...
| [[Gaseous]]     | Is made out of gas. A [[Part]] with this bit will disperse and be destroyed unless combined with a [[Containing]] Bit in a [[Gas Storage]] [[Index/Alchemy/Bits/Bytes/Byte]]. |
...
| [[Mechanical]]  | Requires [[Energy]] to function. Provides cohesive function to parts with [[Mechanical Byte]], connection between parts can be severed.                                       |
...
| [[Organic]]     | This part is alive and requires needs to be met to survive, can provide life to other parts with [[Organic Byte]], connection between parts can be severed.                   |
...
| [[Fragile]]     | This part is able to be broken with ease, can mark other [[Part\|Parts]] with [[Fragile Bytes]], which describe objects that break in specific ways.                          |
